...
class ExperimentResult:
    ...
    # backend-context blocks (scientific_audit, dqe_covenant): machine-readable
    # statement of which environment-dependent backends produced review signals.
    audit_context: Dict[str, Any] = field(default_factory=dict)
    # calibration manifest: free / hand-set parameters governing model outputs.
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "evidence_classes": build_evidence_registry(self.observations),
            "summary": {
                "total": self.total,
                "pass": self.passed,
                "fail": self.failed,
