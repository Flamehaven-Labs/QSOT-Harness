...
REQUIRED_CHECKS = {
    ...
    "accessibility_passes_fully",
    "accessibility_fails_fully",
    "accessibility_penalizes_non_markovianity",
    "accessibility_penalizes_kd_negativity",
    # Phase 6: Rust turbovec
    "rust_verify_binary_runs",
    "rust_turbovec_verdict_is_pass",
    "rust_turbovec_ingested_correct_count",
    "rust_turbovec_quantization_error_within_bounds",
    # Phase 7: Scientific Audit
    "scientific_audit_accepts_flat",
    "scientific_audit_accepts_ads5",
    "scientific_audit_accepts_schwarzschild",
    "scientific_audit_confirms_de_sitter_expected_fail",
    "scientific_audit_confirms_eguchi_hanson_expected_revision",
    "scientific_audit_confirms_godel_universe_expected_fail",
}
...
PHASE_CHECKS = {
    ...
    "phase6_rust_turbovec": [
        "rust_verify_binary_runs",
        "rust_turbovec_verdict_is_pass",
        "rust_turbovec_ingested_correct_count",
        "rust_turbovec_quantization_error_within_bounds",
    ],
    "phase7_scientific_audit": [
        "scientific_audit_accepts_flat",
        "scientific_audit_accepts_ads5",
        "scientific_audit_accepts_schwarzschild",
        "scientific_audit_confirms_de_sitter_expected_fail",
