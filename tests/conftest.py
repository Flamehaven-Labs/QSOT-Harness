...
from qsot_v2.core.config import ExperimentConfig, OutputConfig, PhaseConfig
from qsot_v2.physics import BackgroundField
...
def sample_config():
    return ExperimentConfig(
        ...
        phases=[
            ...
            PhaseConfig(id="phase6_rust_turbovec", enabled=False),
            PhaseConfig(id="phase7_scientific_audit", enabled=False),
        ],
